<?php 
  ...
  if($userd->utype<2){
		...
		if(isset($_GET['ediit'])){
		  ...
		  $sql="SELECT * FROM  `tbl_pathlogy` WHERE id=$_GET[ediit]";
...
?>
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-flask"> </i> Add Pathology</h1>
        </div>       
      </div>
        ...
        <div class="col-md-7">
          <div class="tile">
            <h3 class="tile-title">Register Pathology</h3>
            <hr/>
            <div class="tile-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                      <select name="category" class="form-control">
                        ...
                        <option <?php if($a->category=='Pathology Centre Name'){echo"selected='selected'";} ?> value="Pathology Centre ">Pathology Centre </option>
                        <option <?php if($a->category=='Diagnostic Centre Name'){echo"selected='selected'";} ?> value="Diagnostic Centre ">Diagnostic Centre </option>
                        </select>
                  </div>
                </div>
            ...
            <div class="form-group row">
                  <label class="control-label col-md-3">Pathology Name</label>
                  <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                       ...
                       <img id="blah"  src="pathlogy-image/<?=$list['image'];?>"  width="100%" height="200px"/> 
                  </div>
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" name="pathlogy" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
              </div>
            </div>
