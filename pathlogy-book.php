						   ...
						   <form action="admin/admin/include/save.php" method="post">
							...
							<div class="mt-3">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="dob" value="dd-mm-yy" placeholder="Date" required="">
								</div>
							</div>
							
							<div class="form-group">
							     <label>illness Details</label> 
								<textarea  class="form-control" name="details" placeholder="Test Details & Refer By*" required=""></textarea>
							</div>
							<div class="form-group">
							     <label>Address</label> 
							...
							<button type="submit" name="book-path" class="btn btn-primary submit">Submit Now</button>
						</form>
				</div>
			</div>
			<br/>
