	...
	<div class="container">
		<div class="contact-agile">
			<div class="contact-top">
			    <br/>
				<h2 align="center">Pathology Book / Diagnostic Centre</h2>
...
<section class="w3l-contact ">
 <div class="row">
    ...
    <input type="search" placeholder="Please Search Pathology Name Only" name="search" class="searchbar-input" onkeyup="buttonUp();" required> 
...
<div class="row pt-3 pb-3" style="background:#CE254B;">
    <div class="col-md-3 col-12"> 
      ...
      <option >--Select  Category--</option>
                           <option   value="Pathology Centre"> Pathology Centre   </option>
                        <option   value="Daignostic Centre">  Daignostic Centre </option>
...
<div class="row">
  ...
  <div class="carousel-inner">
        <?php  
        include "admin/admin/include/conn.php";
        $sql="select file_name from tbl_slider where catid=2";
...
<?php 
				...
				if(isset($_POST['search'])){
                     $sreach= $_POST['search'];
				      $sql="SELECT * FROM  `tbl_pathlogy`  WHERE pname LIKE '%$sreach%' ORDER BY RAND()";  
				    
				   }else if(isset($_POST['search2'])){
                     $cat= $_POST['cat'];
                     $state= $_POST['state'];
                     $dis= $_POST['dis'];
				        $sql="SELECT * FROM  `tbl_pathlogy` WHERE category='$cat' and state=$state and district= $dis ORDER BY RAND()";  
				      
				   }
				   else{
				       $sql="SELECT * FROM  `tbl_pathlogy` ORDER BY RAND()";
				   }
...
<div class="card">
  ...
  <img class="card-img-top" src="admin/admin/pathlogy-image/<?=$list['image'];?>" style="height: 200px;width:200px" class="rounded mx-auto d-block"  alt="Card image cap">
  </div>
  <div class="card-body">
  ...
  <div class="card-body">
    ...
    <a href="pathlogy-book.php?did=<?=$list['id'];?>" class="btn btn-warning btn-lg btn-block blink-text" role="button" aria-pressed="true">Book Now</a>
